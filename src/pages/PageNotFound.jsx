...
const PageNotFound = () => {
    return (
        <div>
            <div className="flex h-[calc(100svh-15.6rem)] items-center bg-gray-100 dark:bg-gray-900">
                <div className="container mx-auto flex flex-col items-center justify-center px-5 text-gray-700 md:flex-row">
                    <div className="max-w-md">
                        <div className="font-dark text-5xl font-bold dark:text-white">404</div>
                        <p className="text-2xl font-light dark:text-white leading-normal md:text-3xl">
                            Sorry we couldn't find this page.
                        </p>
                        <p className="mb-8 dark:text-white" >But dont worry, you can find plenty of other things on our homepage.</p>

                        <Link to='/'>

                        <Button className='w-min whitespace-nowrap'>Back to home</Button>
                        </Link>
                    </div>
